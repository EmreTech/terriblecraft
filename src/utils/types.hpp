...
const std::vector<glm::vec3> cubePositions{
    ...
    glm::vec3(4.0f, 0.0f, 0.0f),  glm::vec3(5.0f, 0.0f, 0.0f),
    glm::vec3(6.0f, 0.0f, 0.0f),  glm::vec3(7.0f, 0.0f, 0.0f),
    glm::vec3(8.0f, 0.0f, 0.0f),  glm::vec3(9.0f, 0.0f, 0.0f),
    glm::vec3(10.0f, 0.0f, 0.0f), glm::vec3(11.0f, 0.0f, 0.0f),
    glm::vec3(12.0f, 0.0f, 0.0f), glm::vec3(13.0f, 0.0f, 0.0f),
    glm::vec3(14.0f, 0.0f, 0.0f), glm::vec3(15.0f, 0.0f, 0.0f),
};
